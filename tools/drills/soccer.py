"""The soccer library — the flagship, and the model the other sports follow.

Curated one-offs first (a drill worth authoring by hand because its shape is
the point), then the families: a rondo is really run at 4v2, 5v2 and 6v3, and
    ...
    return [
        ...
        Drill(
            ...
            home=[
                ...
                P(500, 1200, "A", moves=[(420, 1050, 0), (580, 900, 1), (420, 750, 2),
                                         (580, 620, 3), (500, 430, 4)]),
            ],
            markers=[M(500, 1050), M(500, 900), M(500, 750), M(500, 620)],
            ball=0,
            # the ball never leaves his feet through the slalom
            ball_follow=0,
        ),
        ...
        Drill(
            ...
            home=[
                # Played in the attacking half, so the 10's finish is a
                # shot and not a punt from the centre circle.
                P(380, 700, "4", moves=[(420, 520, 0), (500, 440, 1)],
                  why={0: "recover", 1: "cover"}),
                P(620, 740, "5", moves=[(560, 580, 0), (640, 420, 1)],
                  why={0: "recover", 1: "delay"}),
            ],
            away=[
                P(300, 820, "9", moves=[(360, 640, 0)]),
                P(700, 860, "10", moves=[(620, 540, 1)], why={1: "run_behind"}),
            ],
        ...
        Drill(
            ...
            away=[
                P(400, 700, "X1", moves=[(450, 660, 0)]),
                P(640, 640, "X2", moves=[(680, 700, 1)]),
            ],
        ...
        Drill(
            ...
            home=[
                ...
                P(180, 900, "3", role="LB", moves=[(160, 780, 1), (200, 600, 2)],
                  why={1: "width", 2: "turn"}),
            ...
            ball=0,
            # GK to the splitting 4, then down the line to the 3 pushing on
            # …and the 3, free on the outside, drives it out of the third
            ball_to=[(1, 0), (4, 1), (4, 2)],
        ),
        ...
        Drill(
            ...
            ball=0,
            # into the half-space run, carried on, finished
            ball_to=[(2, 0), (2, 1), ((500, 60), 2)],
        ),
        ...
        Drill(
            ...
            ball=0,
            # laid into the 9's arrival, struck first time
        ...
        Drill(
            ...
            home=[
                # The 8 who lost it goes straight back at the man, the 7
                # and 10 shut the lanes either side, the 6 sits behind —
                # and the 8 wins it back before their 5 can find a pass.
                P(500, 720, "8", moves=[(560, 600, 1), (580, 540, 2)],
                  why={1: "press_ball", 2: "win_ball"}),
                P(300, 800, "10", moves=[(400, 620, 1)], why={1: "close_lane"}),
                P(700, 800, "7", moves=[(740, 600, 1)], why={1: "close_lane"}),
                P(500, 920, "6", moves=[(500, 760, 1)], why={1: "cover"}),
            ],
            away=[
                P(600, 560, "5", moves=[(640, 470, 1)], why={1: "turn"}),
                P(760, 520, "2"), P(280, 540, "3"),
            ],
            ball=0,
            # lost right there: their 5 wins it, four blues jump on him,
            # and the 8 takes it straight back — the five seconds the drill
            # is named for, both halves of them
            ball_to=[("a0", 0), (0, 2)],
        ),
        ...
        Drill(
            ...
            ball=0,
            # thrown short to the 7, played down the line to the 9
            ball_to=[(1, 0), (2, 1)],
        ),
        ...
        Drill(
            ...
            home=[
                P(300, 600, "A", moves=[(820, 500, 1)]),
                P(700, 600, "B", moves=[(820, 1000, 2)]),
                P(700, 900, "C", moves=[(180, 1000, 3)]),
                P(300, 900, "D", moves=[(180, 500, 4)]),
                # Steps onto cone one as player 1 leaves it, and receives the
                # closing pass there. See passing_family.
                P(220, 600, "E", moves=[(300, 600, 1)]),
            ],
        ...
        Drill(
            ...
            home=[
                P(330, 600, "A", moves=[(370, 650, 3)]),
                P(670, 600, "B", moves=[(640, 650, 0)]),
                P(670, 920, "C", moves=[(640, 880, 1)]),
                P(330, 920, "D", moves=[(370, 880, 2)]),
            ],
        ...
        Drill(
            ...
            home=[
                ...
                P(620, 880, "8"),
                P(850, 720, "7", moves=[(880, 500, 1), (860, 320, 2)],
                  why={1: "run_behind", 2: "width"}),
                P(600, 600, "9"),
            ],
            away=[
            ...
            ball_to=[(1, 0), (3, 1), (3, 2)],   # …and the 7 drives on down the side
        ),
        Drill(
            ...
            home=[
                ...
                P(520, 620, "9", moves=[(520, 340, 1)], why={1: "near_post"}),
                P(660, 700, "7", moves=[(760, 280, 1)], why={1: "far_post"}),
            ],
            away=[
            ...
            ball_to=[(0, 0), (2, 1), ((520, 60), 2)],   # …and the 7 volleys it in
        ),
        Drill(
            ...
            ball=0,
            # chipped to the 9's arrival and volleyed
            ball_to=[(1, 0), ((500, 60), 1)],
        ),
        Drill(
    ...
    for label, n in shapes.items():
        ...
        out.append(Drill(
            ...
            home=[
                ...
                P(x, y, chr(65 + i), moves=[(*queue_spot(i), i + 1)])
                ...
                # it.
                P(*queue_spot(n - 1), chr(65 + n), moves=[(*spots[0], 1)]),
            ],
...
def gk_family() -> list[Drill]:
    ...
    for key, label, servers, smoves, gkmoves, legs in specs:
        out.append(Drill(
            ...
            home=[
                P(x, y, chr(65 + i), moves=smoves.get(i, []))
...
def overload_family() -> list[Drill]:
    ...
    for att, dfn, minutes in [(3, 2, 10), (4, 3, 12), (5, 4, 15), (6, 4, 15)]:
        ...
        out.append(Drill(
            ...
            away=[P(x, y, f"X{i + 1}", moves=[(*hunt[i], i % 2)])
...
def match_moments() -> list[Drill]:
    """The parts of a match the library had no drill for.

    A coach going through the eight categories found the same holes each
    time: nothing on holding an offside line, nothing on defending a cross
    from open play or a throw-in, nothing on what stays behind while you
    attack, nothing on shooting from distance or on the rebound, no kick-off,
    and no pressing trap. Each of these is a moment that decides matches.
    """
    return [
        Drill(
            id="defend_offside_line", category="defending", minutes=12, rel=True,
            level="advanced", free=True,
            name={"en": "Holding the offside line", "en-GB": "Holding the offside line",
                  "zh-CN": "保持越位线", "zh-TW": "保持越位線",
                  "ja-JP": "オフサイドラインを保つ", "ko-KR": "오프사이드 라인 유지",
                  "es-ES": "Mantener la l\u00ednea de fuera de juego",
                  "fr-FR": "Tenir la ligne de hors-jeu",
                  "id-ID": "Menjaga garis offside", "ms-MY": "Mengekalkan garis ofsaid",
                  "th-TH": "รักษาแนวล้ำหน้า", "vi-VN": "Giữ hàng ngang việt vị"},
            note={"en": "Step out on the ball going backwards, not on a shout. The line is only as high as its deepest defender.",
                  "en-GB": "Step out on the ball going backwards, not on a shout. The line is only as high as its deepest defender.",
                  "zh-CN": "球往回传的那一刻整条线一起上，不要等谁喊。防线的高度由站得最深的那个人决定。",
                  "zh-TW": "球往回傳的那一刻整條線一起上，不要等誰喊。防線的高度由站得最深的那個人決定。",
                  "ja-JP": "ボールが下がった瞬間に全員で出る。声を待つな。ラインの高さは一番深い選手が決める。",
                  "ko-KR": "공이 뒤로 갈 때 함께 나간다. 라인의 높이는 가장 깊이 선 수비수가 정한다.",
                  "es-ES": "Salid cuando el bal\u00f3n va hacia atr\u00e1s, no cuando alguien grita. La l\u00ednea la marca el defensa m\u00e1s retrasado.",
                  "fr-FR": "Sortez quand le ballon recule, pas au cri. La ligne est \u00e0 la hauteur du d\u00e9fenseur le plus bas.",
                  "id-ID": "Maju saat bola dimainkan ke belakang, bukan saat ada teriakan. Garis setinggi bek terdalam.",
                  "ms-MY": "Naik apabila bola dihantar ke belakang. Garisan setinggi pemain paling dalam.",
                  "th-TH": "ขยับขึ้นตอนบอลถูกจ่ายกลับ ไม่ใช่ตอนมีคนตะโกน แนวรับสูงเท่ากับคนที่ยืนต่ำสุด",
                  "vi-VN": "Dâng lên khi bóng được chuyền về, không phải khi có tiếng hô. Hàng ngang cao bằng hậu vệ lùi nhất."},
            home=[
                P(0.18, 0.56, "3", moves=[(0.18, 0.46, 0)]),
                P(0.39, 0.58, "5", moves=[(0.39, 0.48, 0)]),
        ...
        Drill(
            ...
            name={"en": "Defending the cross", "en-GB": "Defending the cross",
                  "zh-CN": "防守传中", "zh-TW": "防守傳中",
                  "ja-JP": "クロス対応", "ko-KR": "크로스 방어",
                  "es-ES": "Defender el centro", "fr-FR": "D\u00e9fendre le centre",
                  "id-ID": "Bertahan dari umpan silang", "ms-MY": "Bertahan hantaran lintang",
                  "th-TH": "ป้องกันลูกครอส", "vi-VN": "Phòng ngự bóng tạt"},
            note={"en": "The first defender attacks the ball, the second covers the cutback. Defend the space in front of the goal, not the man behind you.",
                  "en-GB": "The first defender attacks the ball, the second covers the cutback. Defend the space in front of the goal, not the man behind you.",
                  "zh-CN": "第一个人去争球，第二个人补倒三角。守门前那片空间，不是守你身后那个人。",
                  "zh-TW": "第一個人去爭球，第二個人補倒三角。守門前那片空間，不是守你身後那個人。",
                  "ja-JP": "1人目はボールに行き、2人目がマイナスを消す。守るのは背後の相手ではなくゴール前の空間。",
                  "ko-KR": "첫 수비수는 공을 공격하고 두 번째는 컷백을 막는다. 등 뒤의 사람이 아니라 골 앞 공간을 지켜라.",
                  "es-ES": "El primero ataca el bal\u00f3n, el segundo cubre el pase atr\u00e1s. Defiende el espacio ante la porter\u00eda, no al hombre que tienes detr\u00e1s.",
                  "fr-FR": "Le premier attaque le ballon, le second couvre le retrait. D\u00e9fends l'espace devant le but, pas l'homme derri\u00e8re toi.",
                  "id-ID": "Bek pertama menjemput bola, yang kedua menutup umpan tarik. Jaga ruang di depan gawang, bukan orang di belakangmu.",
        ...
        Drill(
            ...
            off_surface=True,
            name={"en": "Defending the throw-in", "en-GB": "Defending the throw-in",
                  "zh-CN": "防守界外球", "zh-TW": "防守界外球",
                  "ja-JP": "スローイン対応", "ko-KR": "스로인 수비",
                  "es-ES": "Defender el saque de banda", "fr-FR": "D\u00e9fendre la touche",
                  "id-ID": "Bertahan dari lemparan ke dalam", "ms-MY": "Bertahan hantaran ke dalam",
                  "th-TH": "ป้องกันการทุ่ม", "vi-VN": "Phòng ngự ném biên"},
            note={"en": "Take the short options away first. The throw you can head is the one you want them to make.",
                  "en-GB": "Take the short options away first. The throw you can head is the one you want them to make.",
                  "zh-CN": "先把近距离的接应点全部封死。你希望对方扔的，是那个你能顶到的长球。",
                  "zh-TW": "先把近距離的接應點全部封死。你希望對方扔的，是那個你能頂到的長球。",
                  "ja-JP": "まず近い選択肢を消す。相手に投げさせたいのは、こちらが跳ね返せるロングスローだ。",
                  "ko-KR": "짧은 선택지를 먼저 지운다. 상대가 던지길 바라는 건 우리가 걷어낼 수 있는 긴 공이다.",
                  "es-ES": "Quita primero las opciones cortas. El saque que quieres que hagan es el que puedes despejar de cabeza.",
                  "fr-FR": "Supprime d'abord les solutions courtes. La touche que tu veux qu'ils jouent est celle que tu peux repousser de la t\u00eate.",
                  "id-ID": "Tutup dulu opsi pendek. Lemparan yang kamu inginkan adalah yang bisa kamu sundul.",
        ...
        Drill(
            ...
            name={"en": "Rest defence", "en-GB": "Rest defence",
                  ...
                  "th-TH": "แนวรับสำรองขณะบุก", "vi-VN": "Cân bằng phòng ngự khi tấn công"},
            note={"en": "Three stay while the rest attack, and they stand where the counter would come, not where the ball is. Their job starts the second it is lost.",
                  "en-GB": "Three stay while the rest attack, and they stand where the counter would come, not where the ball is. Their job starts the second it is lost.",
                  "zh-CN": "进攻时留三个人，他们要站在对方反击会走的那条路上，不是站在球边。丢球那一秒，他们的活才开始。",
                  "zh-TW": "進攻時留三個人，他們要站在對方反擊會走的那條路上，不是站在球邊。丟球那一秒，他們的活才開始。",
                  "ja-JP": "攻撃中も3人が残る。立つのはボールの近くではなく、カウンターが通る道。仕事は失った瞬間に始まる。",
                  "ko-KR": "공격 중에도 세 명은 남는다. 공 근처가 아니라 역습이 나올 길목에 선다. 그들의 일은 공을 잃는 순간 시작된다.",
                  "es-ES": "Tres se quedan mientras el resto ataca, y se colocan por donde vendr\u00eda el contra, no donde est\u00e1 el bal\u00f3n.",
                  "fr-FR": "Trois restent pendant que les autres attaquent, plac\u00e9s l\u00e0 o\u00f9 passerait le contre, pas l\u00e0 o\u00f9 est le ballon.",
                  "id-ID": "Tiga orang tetap tinggal saat yang lain menyerang, berdiri di jalur serangan balik, bukan di dekat bola.",
                  "ms-MY": "Tiga kekal di belakang semasa yang lain menyerang, berdiri di laluan serangan balas.",
        ...
        Drill(
            ...
            level="advanced",
            name={"en": "Pressing trap: the touchline", "en-GB": "Pressing trap: the touchline",
                  "zh-CN": "边线压迫陷阱", "zh-TW": "邊線壓迫陷阱",
                  "ja-JP": "サイドライン誘導のプレス", "ko-KR": "터치라인 압박 트랩",
                  "es-ES": "Trampa de presi\u00f3n en banda", "fr-FR": "Piège de pressing sur la touche",
                  "id-ID": "Jebakan pressing di garis pinggir", "ms-MY": "Perangkap tekanan di garisan tepi",
                  "th-TH": "กับดักกดดันริมเส้น", "vi-VN": "Bẫy pressing biên"},
            note={"en": "Show him down the line, then squeeze. The touchline is the extra defender — press from outside in and you open the switch you were trying to stop.",
                  "en-GB": "Show him down the line, then squeeze. The touchline is the extra defender — press from outside in and you open the switch you were trying to stop.",
                  "zh-CN": "先把他往边线赶，再收网。边线就是多出来的一个防守人——如果你从外往里压，正好放开了你想封的那记转移。",
                  "zh-TW": "先把他往邊線趕，再收網。邊線就是多出來的一個防守人——如果你從外往裡壓，正好放開了你想封的那記轉移。",
                  "ja-JP": "外へ追い込んでから囲む。タッチラインはもう一人の守備者だ。外から内へ寄せると、止めたかったサイドチェンジを開けてしまう。",
                  "ko-KR": "라인 쪽으로 몰고 조인다. 터치라인이 한 명의 수비수다. 바깥에서 안으로 압박하면 막으려던 전환을 열어준다.",
                  "es-ES": "Ori\u00e9ntalo hacia la banda y aprieta. La l\u00ednea es un defensa m\u00e1s: si presionas de fuera hacia dentro, abres el cambio que quer\u00edas evitar.",
                  "fr-FR": "Oriente-le vers la ligne, puis resserre. La touche est un d\u00e9fenseur de plus : presser de l'ext\u00e9rieur vers l'int\u00e9rieur ouvre le changement d'aile.",
                  "id-ID": "Giring ke garis pinggir lalu jepit. Garis pinggir adalah bek tambahan; menekan dari luar ke dalam membuka umpan silang lapangan.",
                  "ms-MY": "Halakan ke garisan tepi kemudian himpit. Garisan tepi ialah pemain pertahanan tambahan.",
            ...
            home=[
                ...
                P(0.84, 0.44, "7", moves=[(0.88, 0.36, 1), (0.82, 0.44, 2)],
                  why={1: "close_lane", 2: "win_ball"}),
            ...
            ball_to=[("a0", 0), ("a0", 1), (1, 2)],   # …and the trap shuts: the 7 takes it
        ),
        Drill(
            id="finish_long_range", category="finishing", minutes=10, rel=True,
            level="foundation", free=True,
            name={"en": "Shooting from distance", "en-GB": "Shooting from distance",
                  "zh-CN": "远射", "zh-TW": "遠射",
                  "ja-JP": "ミドルシュート", "ko-KR": "중거리 슈팅",
                  "es-ES": "Disparo desde lejos", "fr-FR": "Frappe de loin",
                  "id-ID": "Tembakan jarak jauh", "ms-MY": "Tendangan jarak jauh",
            ...
            note={"en": "Set the ball across your body first, then hit through the middle of it. On target from 25 yards beats perfect over the bar.",
                  ...
                  "fr-FR": "Pousse d'abord le ballon sur le c\u00f4t\u00e9, puis frappe en plein centre. Cadr\u00e9 de 25 m\u00e8tres vaut mieux que parfait au-dessus.",
                  "id-ID": "Dorong bola ke samping badan dulu, lalu tendang tepat di tengahnya. Tepat sasaran dari 25 yard lebih berharga daripada sempurna di atas mistar.",
        ...
        Drill(
            ...
            name={"en": "Second ball in the box", "en-GB": "Second ball in the box",
                  "zh-CN": "禁区补射", "zh-TW": "禁區補射",
                  "ja-JP": "こぼれ球への詰め", "ko-KR": "박스 안 세컨드 볼",
                  "es-ES": "Segunda jugada en el \u00e1rea", "fr-FR": "Deuxi\u00e8me ballon dans la surface",
                  "id-ID": "Bola kedua di kotak penalti", "ms-MY": "Bola kedua dalam kotak",
                  "th-TH": "บอลสองในกรอบ", "vi-VN": "Bóng hai trong vòng cấm"},
            note={"en": "Follow every shot in. Half a yard from the keeper's parry is the easiest goal in football, and nobody is standing there.",
                  "en-GB": "Follow every shot in. Half a yard from the keeper's parry is the easiest goal in football, and nobody is standing there.",
                  "zh-CN": "每一脚射门都跟进。门将脱手后半米的那个球，是足球里最好进的球，而通常那里没人。",
                  "zh-TW": "每一腳射門都跟進。門將脫手後半米的那個球，是足球裡最好進的球，而通常那裡沒人。",
                  "ja-JP": "シュートには必ず詰める。GKが弾いた半歩先はサッカーで一番簡単なゴールで、たいてい誰も立っていない。",
                  "ko-KR": "모든 슛에 따라 들어가라. 골키퍼가 쳐낸 반 걸음 앞은 축구에서 가장 쉬운 골이고, 보통 거기엔 아무도 없다.",
                  "es-ES": "Sigue todos los disparos. Medio metro tras el rechace del portero es el gol m\u00e1s f\u00e1cil del f\u00fatbol, y nadie est\u00e1 ah\u00ed.",
                  "fr-FR": "Suis chaque frappe. Un demi-m\u00e8tre apr\u00e8s le renvoi du gardien, c'est le but le plus facile du football, et personne n'y est.",
                  "id-ID": "Ikuti setiap tembakan. Setengah meter dari tepisan kiper adalah gol termudah, dan biasanya tak ada orang di sana.",
        ...
        Drill(
            ...
            # Both players stand over the ball at kick-off.
            tight=True,
            name={"en": "Kick-off routine", "en-GB": "Kick-off routine",
                  "zh-CN": "开球战术", "zh-TW": "開球戰術",
                  "ja-JP": "キックオフのデザイン", "ko-KR": "킥오프 루틴",
                  "es-ES": "Jugada de saque inicial", "fr-FR": "Coup d'envoi travaill\u00e9",
                  "id-ID": "Skema kick-off", "ms-MY": "Rutin sepak mula",
                  "th-TH": "แผนเขี่ยบอลเริ่มเกม", "vi-VN": "Bài giao bóng"},
            note={"en": "Two passes decided before the whistle: long into the corner and press, or keep it and settle. Deciding at the ball gives it straight back.",
                  "en-GB": "Two passes decided before the whistle: long into the corner and press, or keep it and settle. Deciding at the ball gives it straight back.",
                  "zh-CN": "开球前就定好前两脚：要么直接大脚打角旗区然后压上，要么控住把节奏落下来。站在球边才决定，等于把球还给对方。",
                  "zh-TW": "開球前就定好前兩腳：要麼直接大腳打角旗區然後壓上，要麼控住把節奏落下來。站在球邊才決定，等於把球還給對方。",
                  "ja-JP": "笛の前に最初の2本を決めておく。コーナーへ蹴って圧をかけるか、保持して落ち着かせるか。ボールの前で迷えば、そのまま相手に返す。",
                  "ko-KR": "휘슬 전에 첫 두 번의 패스를 정해 둔다. 코너로 길게 차고 압박하거나, 지키며 안정시키거나. 공 앞에서 정하면 그대로 내준다.",
                  "es-ES": "Dos pases decididos antes del pitido: largo al c\u00f3rner y presi\u00f3n, o conservar y asentarse. Decidir sobre el bal\u00f3n es devolverlo.",
                  "fr-FR": "Deux passes d\u00e9cid\u00e9es avant le coup de sifflet : long dans le corner et pressing, ou conserver et poser le jeu. D\u00e9cider sur le ballon, c'est le rendre.",
                  "id-ID": "Dua umpan sudah diputuskan sebelum peluit: panjang ke pojok lalu tekan, atau tahan dan tenangkan. Memutuskan di bola berarti menyerahkannya kembali.",
                  "ms-MY": "Dua hantaran diputuskan sebelum wisel: panjang ke penjuru lalu tekan, atau simpan dan tenangkan permainan.",
                  "th-TH": "กำหนดสองจังหวะแรกก่อนเป่านกหวีด: โยนยาวไปมุมแล้วกด หรือครองบอลแล้วตั้งเกม ตัดสินใจตอนอยู่หน้าบอลคือคืนบอลให้เขา",
...
# How often each drill is reached for within its category — 3 staple,
# 2 regular (the default, not listed), 1 occasional. A family is one entry,
...
USAGE = {
    ...
    "rondo_4v2": 3, "rondo_": 3, "possession_7v4": 3,
    "rondo_5v2_split": 2, "possession_overload_4v2_plus": 1,
    # warm-up: the passing shapes, the Y, the slalom open most sessions
    "passing_": 3, "warmup_y_pattern": 3, "dribble_slalom": 3,
    "warmup_two_ball": 1,
    # attacking: wall pass and 1v1 every week; the pivot switch rarely
    "wall_pass_wide": 3, "duel_": 3,
    "halfspace_run": 1, "attack_double_pivot_switch": 1,
    # finishing
    "finish_first_time": 3, "one_v_one_gk": 3, "finish_turn_shoot": 3,
    "finish_volley_side": 1, "finish_second_ball_box": 1,
    # defending: 1v1 and 2v2 are the base; formation presses are for a
    # squad that has settled on one
    "defend_1v1_channel": 3, "defend_2v2": 3,
    "press_442": 1, "press_433": 1, "press_4231": 1, "press_352": 1,
    "defend_offside_line": 1, "defend_throw_in": 1,
    "defend_rest_defence": 1, "press_trap_touchline": 1,
    # small-sided games: the plain game closes most sessions
    "ssg_3v3": 3, "ssg_4v4": 3, "ssg_5v5": 3, "ssg_6v6": 3, "ssg_7v7": 3,
    "ssg_6v6_transition": 1,
    # goalkeeping
