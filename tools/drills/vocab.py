...
add('around the outside hitter', '主攻扣球时的掩护', '主攻扣球時的掩護', 'アウトサイドのカバー', '아웃사이드 공격 커버', 'alrededor del atacante de punta', 'autour du pointu réceptionneur', 'di sekitar pemukul luar', 'di sekeliling pemukul luar', 'รอบตัวตบหัวเสา', 'quanh chủ công biên')
add('the quick in front', '近体快', '近體快', 'A クイック', 'A퀵', 'el primer tiempo delante', 'le premier temps devant', 'bola cepat depan', 'bola pantas hadapan', 'บอลเร็วหน้าตัวเซ็ต', 'bóng nhanh trước mặt')
add('the slide behind the setter', '背飞', '背飛', 'バックスライド', '백 슬라이드', 'la slide por detrás del colocador', 'la slide derrière le passeur', 'slide di belakang tosser', 'slide di belakang pengumpan', 'สไลด์ด้านหลังตัวเซ็ต', 'pha slide sau lưng chuyền hai')
add('in a two-passer receive', '两人接发阵型', '兩人接發陣型', '2人レセプションで', '2인 리시브에서', 'en recepción con dos', 'en réception à deux', 'dalam terima servis dua orang', 'dalam terima servis dua orang', 'ในระบบรับสองคน', 'trong đội hình đỡ hai người')
add('the second-ball dump', '二次球偷吊', '二次球偷吊', 'ツーアタック', '세터 다이렉트', 'la finta en el segundo toque', 'la feinte au deuxième ballon', 'dump bola kedua', 'dump bola kedua', 'การหยอดลูกที่สอง', 'pha bỏ nhỏ nhịp hai')

add('off the tee and the front toss', '打击架与前抛喂球', '打擊架與前拋餵球', 'ティーとフロントトス', '티 배팅과 프론트 토스', 'del tee y el toss frontal', 'sur tee et toss de face', 'dari tee dan lemparan depan', 'dari tee dan lambungan depan', 'จากที่ตั้งบอลและการโยนด้านหน้า', 'từ giá đỡ và bóng tung phía trước')
add('the two-strike approach', '两好球后的应对', '兩好球後的應對', '2ストライクからの打撃', '투 스트라이크 대응', 'el enfoque con dos strikes', 'l approche à deux prises', 'pendekatan dua strike', 'pendekatan dua strike', 'แนวทางเมื่อสองสไตรก์', 'cách xử lý khi hai strike')
add('laying down the bunt', '触击技术', '觸擊技術', 'バントの技術', '번트 대는 기술', 'la ejecución del toque', 'poser l amorti', 'teknik bunt', 'teknik bunt', 'เทคนิคการบันต์', 'kỹ thuật chạm bóng')
add('blocking the ball in the dirt', '挡住落地球', '擋住落地球', 'ワンバウンドのブロッキング', '원바운드 블로킹', 'bloquear la bola en tierra', 'bloquer la balle au sol', 'memblok bola yang memantul tanah', 'memblok bola melantun tanah', 'การบล็อกลูกที่เด้งพื้น', 'chắn bóng nảy đất')
add('the throw down to second', '传杀二垒', '傳殺二壘', '二塁への送球', '2루 송구', 'el tiro a segunda', 'le lancer en deuxième', 'lemparan ke base kedua', 'balingan ke base kedua', 'การขว้างไปเบสสอง', 'ném xuống chốt hai')
