...
IconData? _sectionIcon(String label) {
  const table = <String, IconData>{
    ...
    '器材': Icons.flag_outlined,
    '用具': Icons.flag_outlined,
    'Equipment': Icons.flag_outlined,
    '连贯': Icons.loop_rounded,
    '連貫': Icons.loop_rounded,
    'How it continues': Icons.loop_rounded,
